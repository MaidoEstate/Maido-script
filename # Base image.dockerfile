...
if last_processed_page is not None:
    ...
    start_page = int(input("Enter the starting page ID: "))  # Fallback to user input
...
while True:
    ...
    # Check if redirected to the homepage (end condition)
    ...
    if property_detail:
        ...
        # Save data to CSV
        rental_details = "Example rental details"  # Replace with real scraping logic for details
